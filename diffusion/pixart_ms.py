...
from diffusion.builder import MODELS
from diffusion.utils import auto_grad_checkpoint, to_2tuple
from diffusion.pixart_blocks import t2i_modulate, CaptionEmbedder, AttentionKVCompress, MultiHeadCrossAttention, T2IFinalLayer, TimestepEmbedder, SizeEmbedder
from diffusion.pixart import PixArt, get_2d_sincos_pos_embed
...
class PixArtMSBlock(nn.Module):
    ...
    def forward(self, x, y, t, mask=None, HW=None, **kwargs):
        ...
        x = x + self.cross_attn(x, y, mask, **kwargs.get('cross_attn_kwargs', {}))
...
class PixArtMS(PixArt):
    ...
    def forward(self, x, timestep, y, mask=None, data_info=None, **kwargs):
        ...
        if mask is not None:
            ...
            # y = y.squeeze(1).view(bs, -1, x.shape[-1])
